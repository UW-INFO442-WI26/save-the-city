...
export default function HostGardenForm({ onSubmit, onCancel }) {
  ...
  function removeSocialLink(index) {
    ...
    setForm((prev) => ({
      ...prev,
      socialLinks: updatedLinks.length ? updatedLinks : [''],
    }));
  }
  ...
  function handleSubmit(e) {
    ...
    const cleanedSocial = form.socialLinks.filter((link) => link.trim());

    const addressLine = `${form.street}, ${form.city}, ${form.state} ${form.zip}`.trim();

    // IMPORTANT: send HostDash the keys it renders: name, address, tags
    onSubmit({
      name: form.gardenName.trim(),
      ...
      <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="submit" form="garden-form" className="btn btn-success">
              Register Garden
            </button>
          </div>
        </div>
